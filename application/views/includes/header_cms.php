            ...
            <div class="container">
                <div class="md-data">
                    ...
                    <div class="right-data">
                        <ul>
                            <li><a href="<?php echo site_url('residence'); ?>">RESIDENCE</a></li>
                            <?php if($this->session->userdata('user_is_logged_in') == 0): ?>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="myNavbar">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a href="gallery.html">Residence</a></li>
                                        <li><a href="login.html"><img src="<?php echo base_url('assets/site'); ?>/images/icons/login-icon.png"> LOGIN</a></li>
                                        <li><a href="signup.html"><img src="<?php echo base_url('assets/site'); ?>/images/icons/signup.png"> SIGNUP</a></li>
                                    </ul>
                                </div>
                            </div>
                        </nav>
